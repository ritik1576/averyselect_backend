...
path = 'src/modules/grading/grading.service.ts'

with open(path, 'r') as f:
    code = f.read()

old_wrapper = """        let wrappedCode = '';
        if (language === 'python') {
          wrappedCode = `
${code}
import sys
...
new_wrapper = """        let fnName = 'solution';
...
new_exec = """          let rawOutput = stdout.trim();
